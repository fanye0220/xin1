    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className={`bg-slate-900 border border-white/10 rounded-2xl w-full ${activeTab === 'cloud' ? 'max-w-6xl' : 'max-w-md'} transition-all duration-300 overflow-hidden shadow-2xl flex flex-col max-h-[90vh]`}
        >
